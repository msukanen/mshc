...
impl From<GradeA2E> for i8 {
    #[inline]
    fn from(grade: GradeA2E) -> Self {
        // [GradeA2E] will safely fit in `i8`.
        u8::from(grade) as i8
    }
}
...
pub trait GradeA2EMut {
    fn set_grade(&mut self, grade: GradeA2E);
}

impl Add<i32> for GradeA2E {
    type Output = Self;
